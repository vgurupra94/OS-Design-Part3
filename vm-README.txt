...
(D.1) /usr/bin/vfstest (3 out of 6 pts)
...
Cannot halt kernel cleanly : (-5.5 pts)
...
1)  Names and USC e-mail addresses of team members: 
		...
		Manish Lokur       lokur@usc.edu
        Vishal Guruprasad  vgurupa@usc.edu
        Rutul Pandya       rutulbap@usc.edu
...
+---------------------------------------------------------------------------------------+
1. For Section D: Some vfs tests are failing. So 3 out of 6 points.
2. For Section D: All stress tests are passing, hello running fine but kernel not halting cleanly. So 4 out of 6 points.
3. For Section E: (DYNAMIC=1) Only run eatmem test
+-----------------------------------------------+
